...
This project implements a parametric structural canopy using NumPy and a tesselation strategy. The geometry starts with a base NURBS surface generated by deforming a grid using a Perlin Noise Heightmap. This canopy surface is then segmented into planar triangular or quadrilateral panels. The structural supports are generated via a recursive branching algorithm that uses ray-casting to precisely detect the pipe geometry at the point of intersection with the canopy surface. This ensures an accurate and customizable model.
